...
const cardDatabase = [
    ...
    { id: 29, name: 'Drago Bianco Definitivo', type: 'monster', level: 10, race: 'Drago', attribute: 'LUCE', attack: 4500, defense: 3800, extraDeck: true, effect: 'La fusione di tre Draghi Bianchi Occhi Blu: una forza quasi inarrestabile.' },
    ...
    { id: 33, name: 'Il Guardiano del Cancello', type: 'monster', level: 10, race: 'Roccia', attribute: 'TERRA', attack: 3750, defense: 3400, extraDeck: true, effect: 'Fusione di tre guardiani elementali che proteggono un antico portale.' },
