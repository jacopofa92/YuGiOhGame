...
(function () {
    ...
    function consumaEsitoDuello(campaignId) {
        ...
        if (!esito || esito.mode !== 'story' || esito.campaignId !== campaignId) {
            return { avanzato: false, appenaFinita: false, perso: false };
        }
        if (esito.playerWon !== true) return { avanzato: false, appenaFinita: false, perso: true };

        const risultato = avanza(campaignId);
        return { avanzato: true, appenaFinita: risultato.appenaFinita, perso: false };
    }
